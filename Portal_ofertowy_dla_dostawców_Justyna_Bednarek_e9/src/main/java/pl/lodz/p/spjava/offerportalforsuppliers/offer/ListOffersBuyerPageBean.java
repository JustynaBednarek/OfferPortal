 ...
 */
@ViewScoped
@Named("listOffersBuyerPageBean")
public class ListOffersBuyerPageBean implements Serializable{

    static final String GENERAL_MSG_ID = "listOffersBuyerForm:listOffersBuyer";

    public ListOffersBuyerPageBean() {
    }
